...
function loadDynamicPageData(slug: string, locale?: string): DynamicPageLocaleData | null {
  ...
  if (pageConfig.type === 'awards') {
    return {
      type: 'awards',
      config: pageConfig as AwardPageConfig,
    };
  }
...
export default async function DynamicPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <DynamicPageClient dataByLocale={dataByLocale} defaultLocale={runtimeI18n.defaultLocale} pageSlug={slug} />;
}
