        ...
        >
                                            ...
                                            <div className="text-center">
                                                <div className="flex items-center justify-center space-x-2 mb-1">
                                                    ...
                                                    <button
                                                        ...
                                                        className="rounded p-0.5 text-neutral-300 transition-colors duration-200 hover:text-white"
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="mb-6 rounded-xl border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    <h3 className="text-base font-semibold text-primary">{messages.profile.researchInterests}</h3>
                    <div className="mb-3 mt-2 h-0.5 w-10 rounded-full bg-accent" aria-hidden="true" />
                    <div className="divide-y divide-neutral-200 text-sm text-neutral-600 dark:divide-neutral-700 dark:text-neutral-300">
                        {researchInterests.map((interest, index) => (
                            <div key={index} className="px-2 py-2 first:pt-1.5 last:pb-0">{interest}</div>
                        ))}
                    </div>
                </div>
            )}
